...
samp <- select_SSU(df=pop,
                   ...
                   SSU_code="id_ind",
                   PSU_sampled=sample_1st$sample_PSUsample_PSU,
                   verbose=FALSE)
```
