...
For the execution of the function 'prepareInputToAllocation1' it is necessary to assign values to the different parameters. Some of them can be directly derived by available data, but for others, namely: 
...
deff_sugg_sens <- sensitivity (samp_frame=pop,
            errors=cv,
            id_PSU="municipality",
            id_SSU="id_ind",
            strata_var="stratum",
...
```{r, eval=FALSE,results='hide'}
deff_sugg_min <- sensitivity (samp_frame=pop,
            id_PSU="municipality",
            id_SSU="id_ind",
            strata_var="stratum",
            target_vars=c("income_hh","active","inactive","unemployed"),
...
```{r, eval=FALSE,results='hide'}
deff_sugg_sr <- sensitivity (samp_frame=pop,
            id_PSU="municipality",
            id_SSU="id_ind",
            strata_var="stratum",
            target_vars=c("income_hh","active","inactive","unemployed"),
