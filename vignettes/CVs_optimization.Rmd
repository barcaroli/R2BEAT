...
```{r include=FALSE}
set.seed(1234)
solution_genalg <- rbga(stringMin=vettmin, 
                        stringMax=vettmax,
                        evalFunc=fitness_cvs,
                        popSize=10, 
                        iters=50)
```
...
With these new precision constraints, the sample size is greater than the affordable. 
